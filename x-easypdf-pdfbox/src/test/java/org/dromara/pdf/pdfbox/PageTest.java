...
public class PageTest extends BaseTest {
    ...
    public void scaleTest() {
        this.test(
                () -> {
                    try (Document document = PdfHandler.getDocumentHandler().load("E:\\PDF\\pdfbox\\page\\rotationTest.pdf")) {
    ...
    public void cropTest() {
        this.test(
                () -> {
                    try (Document document = PdfHandler.getDocumentHandler().load("E:\\PDF\\pdfbox\\page\\scaleTest.pdf")) {
                        Page page = document.getPage(0);
    ...
    public void resetRectangleTest() {
        this.test(
                () -> {
                    try (Document document = PdfHandler.getDocumentHandler().load("E:\\PDF\\pdfbox\\page\\cropTest.pdf")) {
                        Page page = document.getPage(0);
                        page.resetRectangle();

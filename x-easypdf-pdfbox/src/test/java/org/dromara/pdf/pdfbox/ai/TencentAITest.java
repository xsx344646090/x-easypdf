...
import org.dromara.pdf.pdfbox.core.ext.parser.ai.TencentAIParser;
 ...
 * </p>
 */
public class TencentAITest extends BaseTest {
    ...
    public void parseImageWithPageTest() {
        this.test(() -> {
            ...
            TencentAIParser parser = PdfHandler.getDocumentAIParser(document).getTencentAI(sk, false);
    ...
    public void parsePageWithImageTest() {
        this.test(() -> {
            String sk = System.getenv("sk");
            Document document = PdfHandler.getDocumentHandler().load("E:\\PDF\\pdfbox\\allTest.pdf");
            TencentAIParser parser = PdfHandler.getDocumentAIParser(document).getTencentAI(sk, true);

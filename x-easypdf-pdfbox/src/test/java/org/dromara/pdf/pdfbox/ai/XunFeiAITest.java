...
import org.dromara.pdf.pdfbox.core.ext.parser.ai.XunFeiAIParser;
 ...
 * </p>
 */
public class XunFeiAITest extends BaseTest {
    ...
    public void parseTextWithPageTest() {
        this.test(()->{
            ...
            XunFeiAIParser parser = PdfHandler.getDocumentAIParser(document).getXunFeiAI(ak, sk, false);
    ...
    public void parseTextWithDocumentTest() {
        this.test(()->{
            ...
            String sk = System.getenv("sk");
            Document document = PdfHandler.getDocumentHandler().load("E:\\PDF\\pdfbox\\allTest.pdf");
            XunFeiAIParser parser = PdfHandler.getDocumentAIParser(document).getXunFeiAI(ak, sk, true);

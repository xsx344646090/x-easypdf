...
public class KunLunWanWeiAITest extends BaseTest {
    ...
    public void parseTextWithPageTest() {
        this.test(()->{
            ...
            KunLunWanWeiAIParser parser = PdfHandler.getDocumentAIParser(document).getKunLunWanWeiAI(sk, false);
    ...
    public void parseTextWithDocumentTest() {
        this.test(()->{
            String sk = System.getenv("sk");
            Document document = PdfHandler.getDocumentHandler().load("E:\\PDF\\pdfbox\\allTest.pdf");
            KunLunWanWeiAIParser parser = PdfHandler.getDocumentAIParser(document).getKunLunWanWeiAI(sk, true);

...
public class ByteDanceAITest extends BaseTest {
    ...
    public void parseImageWithPageTest() {
        this.test(()->{
            ...
            ByteDanceAIParser parser = PdfHandler.getDocumentAIParser(document).getByteDanceAI(sk, false);
    ...
    public void parsePageWithImageTest() {
        this.test(()->{
            ...
            String model = System.getenv("model");
            Document document = PdfHandler.getDocumentHandler().load("E:\\PDF\\pdfbox\\allTest.pdf");
            ByteDanceAIParser parser = PdfHandler.getDocumentAIParser(document).getByteDanceAI(sk, true);
            parser.setImageModel(model);

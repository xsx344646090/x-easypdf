...
import org.dromara.pdf.pdfbox.core.ext.templater.EnjoyTemplater;
 ...
 * </p>
 */
public class EnjoyTemplaterTest extends BaseTest {
    ...
    public void getHtmlContentTest() {
        this.test(() -> {
            ...
            templater.setTemplatePath("E:\\PDF\\pdfbox\\template\\enjoy");

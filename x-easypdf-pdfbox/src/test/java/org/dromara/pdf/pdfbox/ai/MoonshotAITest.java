...
import org.dromara.pdf.pdfbox.core.ext.parser.ai.MoonshotAIParser;
 ...
 * </p>
 */
public class MoonshotAITest extends BaseTest {
    ...
    public void parseImageWithPageTest() {
        this.test(()->{
            ...
            MoonshotAIParser parser = PdfHandler.getDocumentAIParser(document).getMoonshotAI(ak, sk, false);
    ...
    public void parseTextWithDocumentTest() {
        this.test(()->{
            ...
            String sk = System.getenv("sk");
            Document document = PdfHandler.getDocumentHandler().load("E:\\PDF\\pdfbox\\allTest.pdf");
            MoonshotAIParser parser = PdfHandler.getDocumentAIParser(document).getMoonshotAI(ak, sk, true);

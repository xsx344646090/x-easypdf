 ...
 * </p>
 */
public class TextAnalyzer extends PDFTextStripper implements Closeable {
     ...
     */
    @Getter
    private final List<TextInfo> textInfoList = new ArrayList<>(64);
     ...
     */
    public TextAnalyzer(PDDocument document) {
     ...
     */
    @Override
    public void writeString(String content, List<TextPosition> textPositions) {
        // 如果文本内容不为空，则分析文本

...
public class COSWriter implements ICOSVisitor {
    ...
    public COSWriter(OutputStream outputStream, RandomAccessRead inputData) throws IOException {
        ...
        compressParameters = CompressParameters.DEFAULT_COMPRESSION;
    ...
    private void doWriteSignature() throws IOException {
        ...
        if (byteRange.length() > byteRangeLength) {
            throw new IOException("Can't write new byteRange '" + byteRange + "' not enough space: byteRange.length(): " + byteRange.length() + ", byteRangeLength: " + byteRangeLength + ", byteRangeOffset: " + byteRangeOffset);
        }

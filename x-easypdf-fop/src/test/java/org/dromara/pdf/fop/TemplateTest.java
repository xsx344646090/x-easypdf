...
public class TemplateTest {
    ...
    public void testThymeleaf2() {
        ...
        TemplateHandler.Template.build()
                ...
                .setDataSource(TemplateHandler.DataSource.Thymeleaf.build().setTemplatePath(templatePath).setTemplateData(data))
    ...
    public void testXml2() {
        ...
        TemplateHandler.Template.build()
                ...
                // .setConfigPath(configPath)
                // 设置XML数据源
                .setDataSource(TemplateHandler.DataSource.XML.build().setTemplatePath(templatePath).setXmlPath(xmlPath))
                // 转换
                .transform(outputPath);
    }
    ...
    public void testFreemarker() {
        ...
        // 设置模板路径
        TemplateHandler.DataSource.Freemarker.setTemplatePath("wiki/xsx/core/pdf/template/freemarker");
        // 定义数据map
        Map<String, Object> data = new HashMap<>();
        // 定义数据list
        List<String> list = new ArrayList<>(2);

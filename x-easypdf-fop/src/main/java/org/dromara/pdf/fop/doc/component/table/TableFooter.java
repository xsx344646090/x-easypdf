...
public class TableFooter {
     ...
     * @return 返回表尾组件
     */
    private TableFooter setInitialCapacity(int initialCapacity) {
     ...
     * @return 返回表尾组件
     */
    public TableFooter setMinRowHeight(String minRowHeight) {
     ...
     * @return 返回表尾组件
     */
    public TableFooter setMinColumnWidth(String minColumnWidth) {
     ...
     * @return 返回表尾组件
     */
    public TableFooter addRow(TableRow... rows) {
     ...
     * @return 返回表尾组件
     */
    public TableFooter addRow(List<TableRow> rows) {
    ...
    public Element createElement(Document document) {
        // 创建tableFooter元素
        Element tableFooter = document.createElement(TemplateTags.TABLE_FOOTER);
        // 遍历表格行列表

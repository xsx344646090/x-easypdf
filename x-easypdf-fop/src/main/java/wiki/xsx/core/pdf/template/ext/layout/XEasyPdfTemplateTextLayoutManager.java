...
public class XEasyPdfTemplateTextLayoutManager extends LeafNodeLayoutManager {
    ...
    private void addMappingAreas(GlyphMapping mapping, int wordSpaceCount, int letterSpaceCount, int firstMappingIndex, int lastMappingIndex, MinOptMax realWidth, LayoutContext context) {
        ...
        TextArea textArea = new XEasyPdfTemplateTextLayoutManager.TextAreaBuilder(realWidth, totalAdjust, context, firstMappingIndex, lastMappingIndex, context.isLastArea(), mapping.font).build();

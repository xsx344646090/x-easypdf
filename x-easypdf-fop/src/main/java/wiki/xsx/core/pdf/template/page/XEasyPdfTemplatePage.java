...
public class XEasyPdfTemplatePage implements XEasyPdfTemplatePageComponent {
    ...
    private Element createSimplePageMaster(Document document, String masterName) {
        ...
        // 设置页面宽度
        simplePageMaster.setAttribute("page-width", this.param.getPageWidth());
        // 设置页面高度
        simplePageMaster.setAttribute("page-height", this.param.getPageHeight());
        // 设置页面上边距
        simplePageMaster.setAttribute("margin-top", this.param.getMarginTop());
        // 设置页面下边距
        simplePageMaster.setAttribute("margin-bottom", this.param.getMarginBottom());
        // 设置页面左边距
        simplePageMaster.setAttribute("margin-left", this.param.getMarginLeft());
        // 设置页面右边距
        simplePageMaster.setAttribute("margin-right", this.param.getMarginRight());
        // 添加页面主体区域
    ...
    private Element createRegionBody(Document document) {
        ...
        // 设置页面主体区域下边距
        regionBody.setAttribute("margin-bottom", this.param.getRegionBodyParam().getMarginBottom());
        // 设置页面主体区域左边距
        regionBody.setAttribute("margin-left", this.param.getRegionBodyParam().getMarginLeft());
        // 设置页面主体区域右边距
        regionBody.setAttribute("margin-right", this.param.getRegionBodyParam().getMarginRight());
        // 返回页面主体区域
        return regionBody;
    }
